...
<!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="门诊卡充值记录编号" align="center" prop="id" />
      <el-table-column label="金额" align="center" prop="money" />
      <el-table-column label="类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.outpatient_recharge_record" :value="scope.row.type"/>
        </template>
      </el-table-column>
...
export default {
  name: "Record",
  dicts: ['outpatient_recharge_record'],
  data() {
    return {
      // 遮罩层
      loading: true,
      ...
      rules: {
        id: [
          { required: true, message: "门诊卡充值记录编号不能为空", trigger: "blur" }
        ],
        money: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除门诊卡充值记录编号为"' + ids + '"的数据项？').then(function() {
